...
import com.mobile.absl.automatedbarcode.model.User;
...
public class RegisterActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void postDataToSQLite(){
        ...
        if (!inputValidation.isInputEditTextPasswordsMatch(textInputEditTextPassword, textInputEditTextConfirmPassword, textInputConfirmPassword, getString(R.string.error_password_match))) {
            return;
        }
        ...
        if(!databaseHelper.checkUser(textInputEditTextEmail.getText().toString().trim())){
            ...
            //SnackBar is used here to show success message
